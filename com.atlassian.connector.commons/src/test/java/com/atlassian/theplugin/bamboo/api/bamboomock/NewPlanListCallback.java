...
public class NewPlanListCallback implements JettyMockServer.Callback {
	public void onExpectedRequest(String target, HttpServletRequest request, HttpServletResponse response)
		...
		Util.copyResourceWithFullPath(response.getOutputStream(), Util.RESOURCE_BASE_2_6 + "planListResponse.xml");
